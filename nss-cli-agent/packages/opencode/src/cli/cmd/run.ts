...
export const RunCommand = effectCmd({
  command: "run [message..]",
  describe: "run nss-cli with a message",
  ...
  builder: (yargs: Argv) =>
    yargs
      ...
      .option("attach", {
        type: "string",
        describe: "attach to a running nss-cli server (e.g., http://localhost:4096)",
      })
      .option("password", {
        alias: ["p"],
        type: "string",
      ...
      .option("username", {
        alias: ["u"],
        type: "string",
        describe: "basic auth username (defaults to NSS_CLI_SERVER_USERNAME or 'nss-cli')",
      })
      .option("dir", {
        type: "string",
