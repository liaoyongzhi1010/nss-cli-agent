...
export const UninstallCommand = {
  command: "uninstall",
  describe: "uninstall nss-cli and remove all related files",
  builder: (yargs: Argv) =>
    yargs
      .option("keep-config", {
        alias: "c",
  ...
  handler: async (args: UninstallArgs) => {
    ...
    UI.println(UI.logo("  "))
    UI.empty()
    prompts.intro("Uninstall NSS CLI")
...
async function showRemovalSummary(targets: RemovalTargets, method: Installation.Method) {
  ...
  if (method !== "curl" && method !== "unknown") {
    const cmds: Record<string, string> = {
      ...
      brew: "brew uninstall nss-cli",
      choco: "choco uninstall nss-cli",
      scoop: "scoop uninstall nss-cli",
    }
...
async function executeUninstall(method: Installation.Method, targets: RemovalTargets) {
  ...
  if (method !== "curl" && method !== "unknown") {
    const cmds: Record<string, string[]> = {
      npm: ["npm", "uninstall", "-g", "nss-cli-agent"],
      pnpm: ["pnpm", "uninstall", "-g", "nss-cli-agent"],
      bun: ["bun", "remove", "-g", "nss-cli-agent"],
      yarn: ["yarn", "global", "remove", "nss-cli-agent"],
  ...
  UI.empty()
  prompts.log.success("Thank you for using NSS CLI!")
}
